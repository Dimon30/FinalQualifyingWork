...
- **Полный бенчмарк** (4 модели × 4 кривые, 2026-05-17 после drag=0.05 + переобучения на dataset_v2):

| Модель | spiral_r3 | circle_r3z5 | helix_r2 | line_diag |
|---|---|---|---|---|
| MLP | 0.024 / 1.23× ✓ | 0.008 / 1.75× ✓ | 18.9 / DIVERGED | 0.068 / 1.14× ✓ |
| SAC | 0.024 / 1.68× ✓ | 0.016 / 2.27× ✓ | 0.030 / 1.47× ✓ | 0.055 / 1.84× ✓ |
| TD3 | 0.016 / 1.66× ✓ | 0.015 / 2.23× ✓ | 0.096 / 1.41× ✓ | 0.045 / 1.76× ✓ |
| PPO | 0.020 / 2.95× ✓ | 0.002 / 3.07× ✓ | 11.5 / DIVERGED | 0.399 / 2.13× |

Значения: e2_rms (м) / speedup (×). DIVERGED означает e2_rms > 1 м.

**Главное достижение**: на всех 16 ячейках бенчмарка ‖v‖_final ≤ 14 м/с (терминал drag-модели). До drag-фикса разгон до 200+ м/с был типичным.
**SAC и TD3 стабильны на всех 4 кривых**. MLP/PPO расходятся только на helix_r2 (OOD).
